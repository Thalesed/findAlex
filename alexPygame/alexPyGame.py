    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if '1' in escolha:
                ...
                if cat == '2':
                    d3 = False
                    usertext = 'Alex não está na porta 3. Deseja manter ou trocar? '
                    if m:
                        e = '1'
                        man = False
                        r = True
                    ...
                    d2 = False
                    usertext = 'Alex não está na porta 2. Deseja manter ou trocar?'
                    if m:
                        e = '1'
                        man = False
                        r = True
            ...
            if '2' in escolha:
                ...
                if cat == '1':
                    ...
                    d1 = False
                    usertext = 'Alex não está na porta 1. Deseja manter ou trocar?  '
                    if m:
                        e = '2'
                        man = False
                        r = True
                ...
                if cat == '1':
                    ...
                    if op == 2:
                        ...
                        if m:
                            ...
                            r = True
                            man = False
        door1 = pygame.image.load('./prt.png')
        door2 = pygame.image.load('./prt.png')
        door3 = pygame.image.load('./prt.png')
        #black = pygame.image.load('./black.jpg')
        tapi = pygame.image.load('./Alex.png')
        win.fill((255, 255, 255))
        ...
        win.blit(tapi, (catpos, 130))
        if vari:
            win.blit(surface1, (30, 300))
        if d1:
            win.blit(door1, (10, 90))
        if d2:
            win.blit(door2, (160, 90))
        if d3:
            win.blit(door3, (310, 90))
